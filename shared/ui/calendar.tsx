  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: 'flex h-9 items-center justify-between',
        caption_label: 'text-sm font-medium capitalize',
        nav:           'contents',
        button_previous: cn(
          buttonVariants({ variant: 'outline' }),
          'order-first h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100',
        ),
        button_next: cn(
          buttonVariants({ variant: 'outline' }),
          'order-last h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100',
        ),
